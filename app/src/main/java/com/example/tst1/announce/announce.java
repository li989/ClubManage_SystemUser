package com.example.tst1.announce;
...
public class announce extends AppCompatActivity {
    ...
    private Handler handler=new Handler(){
        public void handleMessage(Message msg){
            CustomDialog customDialog = new CustomDialog(announce.this);
            customDialog.setTitle("提醒");
            customDialog.setMessage("校园通知标题未填写");
    ...
    private Handler mhandler=new Handler(){
        public void handleMessage(Message msg){
            CustomDialog customDialog = new CustomDialog(announce.this);
            customDialog.setTitle("提醒");
            customDialog.setMessage("校园通知内容未填写");
            customDialog.setConfirm("confirm", new CustomDialog.IOnConfirmListener(){
                @Override
                public void onConfirm(CustomDialog dialog) {
                }
    ...
    private Handler phandler=new Handler(){
        public void handleMessage(Message msg){
            CustomDialog customDialog = new CustomDialog(announce.this);
            customDialog.setTitle("提醒");
            customDialog.setMessage("图片内容未填写");
            customDialog.setConfirm("confirm", new CustomDialog.IOnConfirmListener(){
                @Override
                public void onConfirm(CustomDialog dialog) {
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnexit=(Button)findViewById(R.id.back2);
        Button btnrel2=(Button)findViewById(R.id.update);
        ...
        btnexit.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(announce.this, MainActivity.class);
        ...
        picture.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(ContextCompat.checkSelfPermission(announce.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED){
                    ActivityCompat.requestPermissions(announce.this,new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                }else{
                    openAlbum();
                }
            }
                    ...
                    public void run() {
                        try {
                            if (editText1.getText().toString().equals("")){
                                ...
                                SchoolNoticeManager notice=new SchoolNoticeManager();
                                Beanschoolnotice schoolnotice=new Beanschoolnotice();
                                notice.addSchoolnotice(editText1.getText().toString(),editText2.getText().toString(),datas);
                                Intent intent = new Intent(announce.this, MainActivity.class);
                                startActivity(intent);}
                            shutdown();
